...
const HeroSection = () => {
  ...
  const slides = [
    <div key="1" className="relative h-96 bg-gradient-to-r from-blue-500 to-purple-500">
          ...
          <div className="absolute inset-0 opacity-60 bg-[radial-gradient(circle_at_2px_2px,_white_2px,_transparent_2px)]" style={{ backgroundSize: '40px 40px' }} />
    ...
    <div key="2" className="relative h-96 bg-linear-to-r flex justify-center items-center from-black via-gray-800 to-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_1px_1px,_white_1px,_transparent_1px)]" style={{ backgroundSize: '40px 40px' }} />
